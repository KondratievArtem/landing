...
export const education = [
	{
		icon: html,
		title: 'HTML',
		text: 'При вивчені HTML, дізнався що це не язик програмування, а просто розмітка гіперпосилання. Також що є різні типи тегів, а саме строкові та блокові. Знайомство з сімейством input та посиланнями, і різновидностями типів. Звісно з семантикою та навіщо воно все це потрібно. Canvas потрібно ще підтягнути, але вже розумію що за допомогою цієї технології можна робить круті анімації.',
	},
	{
		icon: css,
		title: 'CSS/SCSS',
