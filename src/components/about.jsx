					...
					<section className="about__about-me about-me">
						...
						<div className="about-me__body">
							<div>
								...
								<p>
									Мені 31 рік. Я вже встиг стати батьком двух дітей. Для мене важливий стабільний дохід. На данний час я працюю в компанії АТБ
									молодшим приймальником товарів (грузчик) по 12годин 4 через 4. Це надає мені можливість навчатися. Я мотивована людина і прагну
									стати фахівцем екстра класу. Тому пошукую собі компанію яка мені в цьому допоможе. А допоки я Вас шукаю, продовжую навчання в IT
									сфері та англійської мови.
								</p>
							</div>
